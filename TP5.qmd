...
Recréer la graphe de freauence de `scheduled_dep_time` colore en fonction d'annulation de vols. 
...
```{r}
#df <- read.csv("t201.csv", sep=";", header = TRUE)
download.file("https://www.insee.fr/fr/statistiques/fichier/7656152/T201.csv", 't201_down.csv')
...
Autrement dit, avec probabilite $1/2$ on peut doubler notre capital ou tout perdre. Si on perds notre capital, on ne peut plus jouer parce que notre capital est egale a zero.
...
# Prenoms des enfants (la semaine de 17 fevrier ou après les vacances)
